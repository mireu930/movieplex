				...
				<div class="row payment-bottom">
					<div class="col-md-6">
						<div class="payment-coupon">
							<h5>쿠폰</h5>
							<div>
								<select class="form-select form-select-sm" id="selectedCoupon"
									aria-label="Small select example">
									<option disabled selected value="default">쿠폰을 선택해주세요</option>
									<c:forEach items="${coupons}" var="v">
										<option value="${v.couponNum }"
											data-coupon-cost="${v.couponDTO.couponCost }">${v.couponDTO.couponName }</option>
									</c:forEach>
								</select>
							</div>

							<div class="alert alert-primary d-flex justify-content-between align-items-center" id="couponArea" role="alert" >
								<span id="couponName"></span>
								<button type="button" class="btn-close" aria-label="Close" id="couponDelete"></button>
							</div>
						</div>
					</div>
					<div class="col-md-6">
							...
							<div id="payment-radio">
								<div class="form-check mb-4">
									<input class="form-check-input" type="radio" name="method"
										id="method1" value="0"> <label
										class="form-check-label" for="method1"> 무통장 입금 </label> <select
										id="bank" class="form-select form-select-sm"
								...
								<div class="form-check">
									<input class="form-check-input" type="radio" name="method"
										id="method2" value="1"> <label
										class="form-check-label" for="method2"> 카드 결제 </label>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="payment-total">
				...
				<div class="payment-summary">
					<div class="payment-item">
						<span id="payment-item-adult"></span> 
						<span id="adult-price"></span>
					</div>
					<div class="payment-item">
						<span id="payment-item-teen"></span> 
						<span id="teen-price"></span>
					</div>
					<div class="payment-item">
						<span>금액</span> <span id="total-amount">13,000원</span>
					</div>
					<div class="payment-item discount">
						<span>할인 적용</span> <span id="discount-amount">0원</span>
					</div>
					<hr>
					<div class="payment-item final">
						<span>최종 결제 금액</span> <span id="final-amount" class="text-success">13,000원</span>
					</div>
				</div>
