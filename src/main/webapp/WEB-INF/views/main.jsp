				...
				<main>
					...
					<div class="album py-5 bg-body-tertiary">
						<div class="container">
							...
							<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" id="movieList">

								<c:forEach items="${topMovieList }" var="top" varStatus="status">
									<div class="col">
										<div class="card shadow-sm" data-movie-id="${top.movieId}">
											<img class="card-img-top"
												src="https://image.tmdb.org/t/p/w500${top.shortPoster }">
											<div class="card-body">
